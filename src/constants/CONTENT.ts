export const APP_TITLE = 'díolta.ie'
export const BASE_URL = 'diolta.ie'
export const BRAND = 'díolta'
export const TAG_LINE = 'When you need something sold'
export const HERO_IMG = '@img/bg/virtual-online-shopping-2400w.jpg'
...
export const CONTACT_EMAIL_SUBJECT = 'díolta.ie Enquiry'
